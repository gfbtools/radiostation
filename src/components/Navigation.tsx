...
import { Music, ListMusic, BarChart3, Settings, Menu, X, UserCircle, LogOut } from 'lucide-react';
...
export default function Navigation() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between px-[6vw] py-4">
          ...
          <div className="hidden md:flex items-center gap-2 relative">
            ...
            >
              <Settings size={15} />
              <span className="text-sm">PRO Accounts</span>
            </button>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-[#B8B8B8] text-sm">{user?.name}</span>
              </button>
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div
                    className="absolute right-0 top-full mt-2 w-48 rounded-2xl overflow-hidden z-[96] py-1"
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[80] bg-[#0B0B0D]/98 backdrop-blur-xl transition-all duration-300 md:hidden ${
      ...
      >
        <div className="flex flex-col items-center justify-center h-full gap-6">
          ...
          <button
            className="flex items-center gap-3 text-red-400 text-2xl"
